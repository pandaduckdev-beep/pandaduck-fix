      ...
      <section className="max-w-md mx-auto px-6 pb-6 sm:pb-8">
        {loading ? (
          ...
          <div className="space-y-3 sm:space-y-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-[#F5F5F7] rounded-[20px] sm:rounded-[28px] p-4 sm:p-6 space-y-3 sm:space-y-4 animate-pulse slide-up" data-animate style={{ animationDelay: `${i * 0.1}s, ${i * 0.1}s` }}>
