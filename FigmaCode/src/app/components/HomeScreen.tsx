    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-md mx-auto px-6 pt-12 pb-16">
        <div className="text-center space-y-6">
          ...
          <div className="pt-4">
            <img
              src="https://images.unsplash.com/photo-1689593671231-ea788fda8414?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxQUzUlMjBEdWFsU2Vuc2UlMjBjb250cm9sbGVyfGVufDF8fHx8MTc2ODkyNzE5M3ww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
      ...
      <section className="max-w-md mx-auto px-6 pb-20">
        <div className="grid grid-cols-2 gap-3">
          {/* Stick Drift Fix */}
          <button 
            className="bg-[#F5F5F7] rounded-[28px] p-6 space-y-4 text-left hover:bg-[#EBEBED] transition-colors active:scale-[0.98]" 
            onClick={() => handleServiceClick('hall-effect')}
          >
          ...
          <button 
            className="bg-[#F5F5F7] rounded-[28px] p-6 space-y-4 text-left hover:bg-[#EBEBED] transition-colors active:scale-[0.98]" 
            onClick={() => handleServiceClick('clicky-buttons')}
          >
            <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center">
          ...
          <button 
            className="bg-[#F5F5F7] rounded-[28px] p-6 space-y-4 text-left hover:bg-[#EBEBED] transition-colors active:scale-[0.98]" 
            onClick={() => handleServiceClick('back-buttons')}
          >
            <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center">
          ...
          <button 
            className="bg-[#F5F5F7] rounded-[28px] p-6 space-y-4 text-left hover:bg-[#EBEBED] transition-colors active:scale-[0.98]" 
            onClick={() => handleServiceClick('battery')}
          >
            <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center">
