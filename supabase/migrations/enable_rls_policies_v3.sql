...
-- Note about Views:
-- Views (daily_expense_stats, daily_revenue_stats, etc.) cannot have RLS applied.
-- They inherit permissions from underlying tables.
-- Since expenses table requires authentication, views will be protected automatically.
